    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="normal-table-list">
                ...
                ?>
                <?php echo form_open_multipart('dorm/save'); ?>
                <div class="bsc-tbl">
                    <div class="form-example-int">
                        ...
                        <div class="form-example-int mg-b-15 col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="nk-int-st">
                                    <textarea class="form-control input-sm" name="address" id="address" placeholder="ที่อยู่หอพัก"><?php echo set_value('address'); ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-example-int mg-b-15 col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="nk-int-st">
                                    <input type="text" class="form-control input-sm" name="phone" id="phone" value="<?php echo set_value('phone'); ?>" placeholder="เบอร์โทร">
                                </div>
                            </div>
                        </div>
