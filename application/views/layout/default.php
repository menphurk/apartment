...
<body>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="tab-content custom-menu-content">
                            ...
                            <div id="Dorms" class="tab-pane notika-tab-menu-bg animated flipInX">
                                <ul class="notika-main-menu-dropdown">
                                    <li><a href="<?php echo base_url(); ?>dorm/index">ข้อมูลหอพัก</a>
                                    </li>
                                    <li><a href="<?php echo base_url(); ?>dorm/create">เพิ่มหอพัก</a>
                                    </li>
                                </ul>
                            </div>
                            <div id="Members" class="tab-pane notika-tab-menu-bg animated flipInX">
                                <ul class="notika-main-menu-dropdown">
                                    ...
                                    <li><a href="<?php echo base_url(); ?>member/create">สร้างผู้เช่า</a>
                                    </li>
                                </ul>
                            </div>
    ...
    <div id="<?php if ($this->session->userdata('login_id')) {
                    echo 'normal-table-area';
                } ?>">
        <?php echo $contents; ?>
    </div>
